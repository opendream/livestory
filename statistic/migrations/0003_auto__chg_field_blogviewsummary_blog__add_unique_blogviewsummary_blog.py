...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BlogViewSummary.blog'
        db.alter_column('statistic_blogviewsummary', 'blog_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['blog.Blog'], unique=True))
        # Adding unique constraint on 'BlogViewSummary', fields ['blog']
        db.create_unique('statistic_blogviewsummary', ['blog_id'])

    def backwards(self, orm):
        # Removing unique constraint on 'BlogViewSummary', fields ['blog']
        db.delete_unique('statistic_blogviewsummary', ['blog_id'])


        # Changing field 'BlogViewSummary.blog'
        db.alter_column('statistic_blogviewsummary', 'blog_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blog.Blog']))
    models = {
        'auth.group': {
