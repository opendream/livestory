...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Blog.related_url'
        db.add_column('blog_blog', 'related_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Adding field 'Blog.download_url'
        db.add_column('blog_blog', 'download_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
    def backwards(self, orm):

        # Deleting field 'Blog.related_url'
        db.delete_column('blog_blog', 'related_url', self.gf('django.db.models.fields.URLField')(default=''))

        # Deleting field 'Blog.download_url'
        db.delete_column('blog_blog', 'download_url', self.gf('django.db.models.fields.URLField')(default=''))
    models = {
        'auth.group': {
